 ...
 ***************************************************************************/
/**
 * @file CIDetectorConstructionMessenger.h
 * @brief
 *
 * @date Sep 8, 2009
 *
...
#ifndef CIDETECTORCONSTRUCTIONMESSENGER_H_
#define CIDETECTORCONSTRUCTIONMESSENGER_H_

#include "G4UImessenger.hh"

class CIDetectorConstruction;
class G4UIdirectory;
...
/**
 * @class CIDetectorConstructionMessenger
 ...
 *
 */
class CIDetectorConstructionMessenger : public G4UImessenger {
public:
	CIDetectorConstructionMessenger(CIDetectorConstruction* pCIDetectorConstruction);
	virtual ~CIDetectorConstructionMessenger();

  /**
   * Process commands from the macro and invoke the appropriate response in CIDetectorConstruction
...
protected:
  /// Pointer to the CIDetectorConstruction whose details are to be set
	CIDetectorConstruction*          m_pCIDetectorConstruction;
...
#endif /* CIDETECTORCONSTRUCTIONMESSENGER_H_ */
