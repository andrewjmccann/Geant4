 ...
 *   All SiPM Modular imager design - Small Module
 *                                                                         *
 ***************************************************************************/
/**
 * @file CIModularImager3.cpp
 * @brief Build an all-SiPM modular imager consisting of four scatter pixels and four absorber pixels. 
 *
 * @date 2008/12/08
 *
...
FullDetectorConstruction::FullDetectorConstruction(CISensitiveScintiDetector* pCISensitiveScintiDetector, CISensitiveOpticalDetector* pCISensitiveOpticalDetector, CISensitiveMaterials* pCISensitiveMaterials) :
	m_pCISensitiveScintiDetector(pCISensitiveScintiDetector),
			...
			m_worldSize(10* m , 10* m , 22* m ), m_sipmHalfSize(0,0, 0), m_xtalHalfSizeS(6.75 * mm, 6.75 * mm, 6.75 * mm), m_xtalHalfSizeA(14.0 * mm, 14.0 * mm, 14.0* mm), m_iNSCellX(4), m_iNSCellY(4), m_iNSCellZ(1), m_iNACellX(4), m_iNACellY(4), m_iNACellZ(1), m_dSCellGap(6.5 * mm, 6.5 * mm, 79.5 * mm), m_dACellGap(4.0 * mm, 4.0 * mm, 0 * mm), m_dASGap(85 * mm), m_dSTotalZ(0), m_pMessenger(NULL) {
...
void FullDetectorConstruction::ConstructScatter(G4int& iCell) {
	...
	G4ThreeVector PCBHalfSize(12.8/2.0 *cm,12.8/2.0 *cm, 1.58/2.0*mm); //Size Unknown!. Up until carbon fibure
	...
	G4ThreeVector carbonfibreHalfSize(64.*mm,64.*mm, 0.4*mm); //Size Unknown!. Up until carbon fibure
